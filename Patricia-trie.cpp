...
int main() {
    Trie trie;
    ifstream file(R"(C:\Users\Lenovo\Desktop\prog4\wiki-100k.txt)");
    int count = 0;
    ...
    cout << trie.search("mile") << endl;
    cout << trie.search("apppel") << endl;
    cout << trie.search("tututata") << endl;
    cout << trie.search("bank") << endl;
